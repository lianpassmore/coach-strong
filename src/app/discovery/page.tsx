  ...
  return (
    <main className="min-h-screen bg-brand-dark text-white font-sans flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-8 text-center max-w-sm mx-auto w-full pb-12">
        ...
        {/* THE ORB (The Digital Brain Visual) */}
        ...
        <h1 className="font-heading text-4xl tracking-widest mb-4 leading-none">
          MEET YOUR<br />DIGITAL BRAIN
        </h1>
        ...
        <div className="w-full space-y-3 mb-10">
          <FeatureItem 
            ...
            title="Deep Context" 
            desc="She already knows your goals. This is about the 'Why'." 
          />
          <FeatureItem 
            icon={<ShieldCheck className="w-4 h-4" />} 
            title="Safe Space" 
            desc="Speak freely. Your honesty builds a more accurate plan." 
          />
        </div>
...
function FeatureItem({ icon, title, desc }: { icon: any, title: string, desc: string }) {
  return (
    <div className="flex gap-4 bg-white/5 border border-white/5 rounded-2xl p-4 text-left backdrop-blur-sm">
      <div className="w-8 h-8 rounded-xl bg-brand-light/10 flex items-center justify-center shrink-0 text-brand-light">
        {icon}
      </div>
      <div>
